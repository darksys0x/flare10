            ...
            if 'jmp' in insn.mnem:
                ...
                if max_fn_calls > 0 and current_depth < max_call_depth:
                    ...
                    if call_insn.ea in branches:
                        ...
                        if call_insn.ea == 0:
                            print("Call: It's  Fuckking 1 ZEROOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOO")
                        #     exit(0)
            elif 'j' in insn.mnem:
                if max_j_depth > 0:
                    jmp_insn = self._follow_jmp_chain(insn)
                    if jmp_insn.ea in branches:
                        ...
                        if jmp_insn.ea == 0:
                            print("j: It's  Fuckking 2 ZEROOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOO")
                            #exit(0)
